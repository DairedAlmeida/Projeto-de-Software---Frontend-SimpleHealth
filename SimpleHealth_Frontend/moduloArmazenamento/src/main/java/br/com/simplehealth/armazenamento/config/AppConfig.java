...
public class AppConfig {
    ...
    public static final String ITENS_API_URL = API_BASE_URL + "/api/itens";
    public static final String FORNECEDORES_API_URL = API_BASE_URL + "/api/fornecedores";
    public static final String PEDIDOS_API_URL = API_BASE_URL + "/api/pedidos";
    public static final String ESTOQUES_API_URL = API_BASE_URL + "/api/estoques";
